...
export default function DoctorLoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { profile } = await signInWithRole({ email, password, expectedRole: "doctor" });
        ...
        <Card className="p-8">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link to="/doctor/reset-password" className="text-blue-600 hover:text-blue-700">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            Doctor accounts are provisioned by an administrator. If you need access, please contact support.
          </div>
        </Card>
